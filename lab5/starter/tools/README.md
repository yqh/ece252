This directory contains a script named `run_lab5.sh` to help you gather the timing data of your `findpng3` program when the seed\_url is [http://ece252-1.uwaterloo.ca/lab5](http://ece252-1.uwaterloo.ca/lab5).
